        ...
        <div className='text-center py-10 bg-sky-100'>
            ...
            <div className='lg:flex lg:justify-center gap-6'>
                ...
                <div className="card w-96 bg-base-100 shadow-xl rounded-none">
                    <figure><img src="https://rb.gy/7en8a" alt="Food" className='p-2 w-[100%] h-[242px]' /></figure>
                ...
                <div className="card w-96 bg-base-100 shadow-xl rounded-none">
                    <figure><img src="https://rb.gy/48i7z" alt="Food" className='p-2 w-[100%] h-[242px]'/></figure>
                    <div className="card-body">
                        <h2 className="card-title mx-auto">
